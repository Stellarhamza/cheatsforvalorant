...
const reviewImagePaths = [
	...
	valorantImages.radarHack,
	valorantImages.cover,
	valorantImages.loadoutBuilder,
	valorantImages.playerEsp,
	valorantImages.squadFight,
	valorantImages.headerArt,
	valorantImages.cheatsPackage,
	valorantImages.battleRoyaleCombat,
] as const;
	...
	customerReviews.forEach((review, index) => {
		...
		entries.push({
			...
			images: [
				{
					url: image.url,
					title: `Valorant Cheats review by @${review.handle}`,
