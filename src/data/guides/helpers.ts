...
export const NATIVE_GAME_GUIDES_CATEGORY = 'Valorant Game Guides';

/** Trusted third-party Valorant resources shown below native guides on /guides/. */
export const valorantAuthorityLinks = [
	{
		title: 'Valorant on Steam',
		description: 'Official store page, system requirements, and player reviews.',
		href: 'https://store.steampowered.com/app/230410/Valorant/',
	},
	{
		title: 'Valorant patch notes & news',
		description: 'Read official PC update posts before you change your loadout.',
		href: 'https://playvalorant.com/en-us/news/',
	},
	{
		title: 'Official Valorant website',
		description: 'Game overview, news, and resources from Riot Games.',
		href: 'https://playvalorant.com/',
	},
	{
		title: 'Valorant Steam community hub',
		description: 'Announcements, guides, and community discussions.',
		href: 'https://steamcommunity.com/app/230410',
	},
] as const;

/** Pedagogical order for native Valorant guides on the hub. */
const NATIVE_GUIDE_ORDER = [
	'valorant-new-player-guide',
	'valorant-match-types-guide',
	'valorant-factions-explained',
	'valorant-open-world-farming',
	'valorant-steel-path-guide',
	'valorant-patch-notes-guide',
];
...
/** Native Valorant game guides from the blog — shown at top of /guides/. */
export function getNativeValorantGuides() {
			...
			images: [
				{
					...
					caption: 'Valorant native guides and multi-game gameplay guides',
				},
			],
		},
	];
