...
const imageMap: Record<BlogImageKey, string> = {
	...
	squadFight: valorantImages.squadFight,
	headerArt: valorantImages.headerArt,
	cheatsPackage: valorantImages.cheatsPackage,
	playerEsp: valorantImages.playerEsp,
	rebootFight: valorantImages.rebootFight,
			...
			images: [
				{
					...
					title: 'Valorant Cheats Intel blog',
					caption: 'Valorant Intel blog covering meta guides, ESP, Aimbot, and EAC notes',
				},
			],
		},
	];
