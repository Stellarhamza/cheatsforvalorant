...
const enGallery: GalleryUi = {
	...
	subtitle:
		'Real Valorant cheat screenshots — ESP boxes, wallhack overlays, aimbot menus, and radar — from the undetected PC package players use in Competitive, Spike Rush, and map rotations missions.',
	lead:
		'Valorant Cheats is built for Valorant on Windows PC: read enemy, enemy, and enemy units through cover, track flank spawns on a 2D radar, tune soft aim before missions, and buy one license that covers ESP, wallhack, and aimbot together.',
	highlights: [
		{
			title: 'Enemy & objective ESP',
			copy: 'Box, skeleton, and health-bar readouts on enemy, enemy, and enemy units through tileset geometry so you pick fights with real intel.',
		},
		{
		...
		{
			title: 'Why players pick Valorant Cheats',
		...
		},
		{
			...
			copy: 'After Riot Games anti-cheat patches we rebuild and post status on Updates before you queue — less guesswork on patch day.',
		},
		{
			title: 'PC + controller ready',
			copy: 'Profiles and hotkeys for mouse/keyboard plus controller support so the same build works in map rotations zones and Competitive.',
		},
		{
