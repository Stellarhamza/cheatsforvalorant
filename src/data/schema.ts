...
> = {
	hacks: [
		{
			...
			answer:
				'Valorant cheats are Windows PC tools for Valorant with ESP, wallhack, and aimbot controls. Valorant Cheats licenses include anti-cheat maintenance updates and setup support.',
		},
		{
	...
	'valorant-esp': [
		{
			...
			answer:
				'A Valorant wallhack is an ESP overlay that shows enemy units and enemys, heavy attacks, and loot through cover. Valorant Cheats wallhack includes distance readouts, team colours, and toggleable categories for Competitive missions and map rotations missions.',
		},
		{
			question: 'Does Valorant Cheats include a radar hack?',
			answer:
				'Yes. Valorant Cheats includes 2D radar-style overlays that highlight nearby threats outside your direct view — useful for reading flanks during team pushes.',
		},
		{
			question: 'Does this fit Competitive missions and map rotations missions runs?',
			answer:
	...
	'valorant-aimbot': [
		{
			...
			answer:
				'Valorant aimbot is configurable aim assist with smoothness, FOV, and bone priority controls. It ships bundled with ESP and radar in the Valorant Cheats license for Windows PC.',
		},
		{
			question: 'Can I use Valorant aimbot with a controller?',
			answer:
				'Yes. Valorant Cheats supports controller play on Windows PC. Tune FOV and smoothness per weapon profile after setup.',
		},
		{
			question: 'Are Valorant cheats permanently undetected?',
			answer:
	...
	pricing: [
		...
		},
		{
			...
			answer:
				'The monthly license includes ESP, wallhack overlays, radar, and aimbot controls with anti-cheat maintenance updates for Valorant on Windows PC.',
		},
		{
			question: 'Is the $150 lifetime license worth it?',
			answer:
				'Lifetime pays off if you play Valorant across multiple seasons. It includes the same feature stack as monthly with long-term maintenance after patches.',
		},
	],
	features: [
		{
		...
		},
		{
			...
			answer:
				'Yes — Valorant Cheats is built for Valorant on Windows 10 and 11 with in-client toggles for ESP, radar, and aimbot.',
		},
		{
			question: 'How does anti-cheat affect Valorant Cheats?',
			answer:
				'Anti-cheat monitors Valorant on Windows PC. Valorant Cheats publishes maintenance notes after patches that may require a rebuild. Read the maintenance guide page for how updates are handled.',
		},
	],
};
