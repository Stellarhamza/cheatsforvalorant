...
const PAGE_META_TAILS = {
	'valorant-esp': { suffix: 'enemy boxes & Wallhack', focus: 'enemy boxes, health bars, and wallhack overlays' },
	'valorant-aimbot': { suffix: 'Soft Aim Controls', focus: 'soft aim, FOV, and per-weapon Aimbot profiles' },
	features: { suffix: 'Full Feature List', focus: 'ESP, aimbot, wallhack, and radar controls' },
	...
	wallhack: { suffix: 'ESP Visibility', focus: 'wallhack ESP for agents, utility, and the spike' },
	...
	'esp-hack': { suffix: 'Boxes & Utility', focus: 'ESP hack boxes, spike markers, and distance' },
...
function productPage(locale, pageKey, topicName, cta2href) {
	...
	return {
		...
		sections: [
			section(`${topicName} — ${p.maps}`, p.s1(`Read enemy agents with ESP wallhack.`), p.s2()),
			section(`ESP wallhack & ${p.undetected}`, p.s1('Toggle overlays for Competitive, Unrated, and Spike Rush.'), p.s3()),
